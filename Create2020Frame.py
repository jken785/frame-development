...
def createBaseFrame():
    ...
    frame.addTube(RD_75x28, RD_5x35, "upper-left-fronthoop", "mid-upper-left-sideimpact", True, True)
    frame.addTube(SQ_1x49, RD_5x35, "fore-upper-left-sideimpact", "mid-upper-left-sideimpact", True, True,
                  "UpperSideImpact")
    frame.addTube(SQ_1x49, RD_5x35, "lower-aft-left-frontbox", "mid-upper-left-sideimpact", True, True)
    frame.addTube(SQ_1x49, RD_5x35, "lower-aft-left-frontbox", "left-lower-mainhoop", True, True)
    frame.addTube(SQ_1x49, RD_5x35, "mid-upper-left-sideimpact", "left-sideimpact-mainhoop", True, True,
                  "UpperSideImpact")
    frame.addTube(SQ_1x49, RD_5x35, "mid-upper-left-sideimpact", "left-lower-mainhoop", True, True)
    ...
    frame.addTube(SQ_625x35, RD_5x35, "lower-aft-left-frontbox", "frontbox-crossbrace", False, False, "Crossbrace3")
    ...
    frame.addTube(RD_625x28, RD_5x35, "foremost-enginemount-mirror", "engine-to-harness#m", False, True)
    frame.addTube(RD_1x49, RD_5x35, "left-sideimpact-mainhoop", "foremost-enginemount", False, True)
    frame.addTube(RD_1x49, RD_5x35, "left-sideimpact-mainhoop#m", "foremost-enginemount-mirror", False, True)
    ...
    frame.addTube(RD_625x49, RD_5x35, "upper-fore-rearbox", "lower-fore-rearbox", True, True)
    ...
    frame.addTube(RD_625x49, RD_5x35, "upper-aft-rearbox", "lower-aft-rearbox", True, True)
    frame.addTube(RD_75x49, RD_5x35, "lower-fore-rearbox", "lower-aft-enginemount", True, True)
    frame.addTube(RD_625x49, RD_5x35, "lower-aft-enginemount", "lower-mid-rearbox", False, True)
    frame.addTube(RD_5x49, RD_5x35, "lower-aft-enginemount#m", "lower-mid-rearbox#m", False, True)
    frame.addTube(RD_1x35, RD_5x35, "lower-aft-rearbox", "lower-aft-rearbox#m", False, True)
    frame.addTube(RD_75x35, RD_5x35, "upper-aft-rearbox", "rear-v-towbar", False, True)
    frame.addTube(RD_75x35, RD_5x35, "upper-aft-rearbox#m", "rear-v-towbar", False, True)
    ...
    frame.addTube(RD_1x35, RD_5x35, "upper-fore-rearbox", "upper-aft-enginemount", False, True)
    frame.addTube(RD_1x35, RD_5x35, "upper-fore-rearbox#m", "upper-aft-enginemount-mirror", False, True)
    frame.addTube(RD_625x35, RD_5x35, "upper-fore-rearbox", "upper-rearRockerPlane", True, True)
    frame.addTube(RD_1x35, RD_5x35, "upper-rearRockerPlane", "upper-aft-enginemount", False, True, "toEngineMount")
    frame.addTube(RD_1x35, RD_5x35, "upper-rearRockerPlane#m", "upper-aft-enginemount-mirror", False, True, "toEngineMount")
    ...
    frame.addTube(RC_1x1_5x65, RD_5x35, "rear-arb", "rear-arb#m", False, False)
    frame.addTube(RD_625x49, RD_5x35, "upper-aft-enginemount", "rear-arb", False, False)
    frame.addTube(RD_625x49, RD_5x35, "upper-aft-enginemount-mirror", "rear-arb#m", False, False)
    frame.addTube(RD_75x35, RD_5x35, "upper-aft-rearbox", "rear-arb", True, False)
