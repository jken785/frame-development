...
def createFrame():
    ...
    frame.addNode('upper-left-bulkhead#m', 17.852000, 6.929000, 17.195000, True, True)
    frame.addNode('lower-left-bulkhead', 17.852000, -6.929000, 4.820000, True, True)
    frame.addNode('lower-left-bulkhead#m', 17.852000, 6.929000, 4.820000, True, True)
    frame.addNode('upper-fore-left-frontbox', 33.203000, -8.690000, 8.932000, True, True)
    frame.addNode('upper-fore-left-frontbox#m', 33.203000, 8.690000, 8.932000, True, True)
    frame.addNode('lower-fore-left-frontbox', 33.652000, -6.929000, 4.820000, True, True)
    frame.addNode('lower-fore-left-frontbox#m', 33.652000, 6.929000, 4.820000, True, True)
    frame.addNode('upper-aft-left-frontbox', 44.194000, -8.584000, 8.907000, True, True)
    frame.addNode('upper-aft-left-frontbox#m', 44.194000, 8.584000, 8.907000, True, True)
    frame.addNode('lower-aft-left-frontbox', 43.970000, -6.929000, 4.820000, True, True)
    frame.addNode('lower-aft-left-frontbox#m', 43.970000, 6.929000, 4.820000, True, True)
    frame.addNode('left-frontdamper', 40.200000, -9.000000, 17.250000, True, True)
    frame.addNode('left-frontdamper#m', 40.200000, 9.000000, 17.250000, True, True)
    frame.addNode('fore-upper-left-sideimpact', 44.788153, -9.768488, 12.500000, True, True, 4.000000, 0.000000,
                  1.000000, 2.000000, 0.000000, 0.000000)
    frame.addNode('fore-upper-left-sideimpact#m', 44.788153, 9.768488, 12.500000, True, True, 4.000000, 0.000000,
                  2.000000, 1.000000, 0.000000, 0.000000)
    frame.addNode('upper-left-fronthoop', 44.923388, -5.532477, 22.706796, True, True, 3.000000, 2.000000, 1.000000,
                  3.000000, 1.000000, 1.000000)
    frame.addNode('upper-left-fronthoop#m', 44.923388, 5.532477, 22.706796, True, True, 3.000000, 2.000000, 3.000000,
                  1.000000, 1.000000, 1.000000)
    frame.addNode('mid-upper-left-sideimpact', 63.277477, -11.082772, 12.737000, True, False, 5.000000, 5.000000,
                  2.000000, 6.000000, 0.000000, 0.000000)
    frame.addNode('mid-upper-left-sideimpact#m', 63.277477, 11.082772, 12.737000, True, False, 5.000000, 5.000000,
                  6.000000, 2.000000, 0.000000, 0.000000)
    frame.addNode('left-lower-mainhoop', 73.150000, -11.260565, 2.000000, True, True, 0.000000, 0.000000, 2.000000,
                  3.000000, 0.000000, 0.000000, 'MainHoop')
    frame.addNode('left-lower-mainhoop#m', 73.150000, 11.260565, 2.000000, True, True, 0.000000, 0.000000, 3.000000,
                  2.000000, 0.000000, 0.000000, 'MainHoop')
    frame.addNode('left-sideimpact-mainhoop', 73.150000, -12.203259, 12.993000, True, True, 0.000000, 0.000000,
                  1.000000, 4.000000, 0.000000, 0.000000, 'MainHoop')
    frame.addNode('left-sideimpact-mainhoop#m', 73.150000, 12.203259, 12.993000, True, True, 0.000000, 0.000000,
                  4.000000, 1.000000, 0.000000, 0.000000, 'MainHoop')
    frame.addNode('left-harnessbar-mainhoop', 73.150000, -10.550000, 23.100000, True, True)
    frame.addNode('left-harnessbar-mainhoop#m', 73.150000, 10.550000, 23.100000, True, True)
    frame.addNode('left-brace-mainhoop', 73.150000, -6.283640, 36.552920, True, True, 0.000000, 0.000000, 0.000000,
                  2.000000, 0.000000, 2.000000, 'MainHoop')
    frame.addNode('left-brace-mainhoop#m', 73.150000, 6.283640, 36.552920, True, True, 0.000000, 0.000000, 2.000000,
                  0.000000, 0.000000, 2.000000, 'MainHoop')
    frame.addNode('nipple-mainhoop', 73.150000, 0.000000, 43.210474, False, True, 0.000000, 0.000000, 0.000000,
                  0.000000, 3.000000, 1.000000, 'MainHoop')
    frame.addNode('seat-crossbrace', 60.109972, 0.000000, 2.246634, False, True, 1.000000, 1.000000, 0.000000, 0.000000,
                  1.000000, 1.000000)
    frame.addNode('frontbox-crossbrace', 40.803588, 0.000000, 4.146901, False, True, 2.000000, 1.000000, 0.000000,
                  0.000000, 0.000000, 1.000000)
    frame.addNode('left-rockernode', 40.200000, -6.929000, 4.820000, True, True)
    frame.addNode('left-rockernode#m', 40.200000, 6.929000, 4.820000, True, True)
    frame.addNode('engine-to-harness', 75.698000, -9.598000, 23.100000, True, True)
    frame.addNode('engine-to-harness#m', 75.698000, 9.598000, 23.100000, True, True)
    ...
    frame.addNode('end-of-bend-harness#m', 76.650000, 7.300000, 23.100000, True, True)
    frame.addNode('upper-fore-rearbox', 93.554400, -8.600000, 10.944000, True, True)
    frame.addNode('upper-fore-rearbox#m', 93.554400, 8.600000, 10.944000, True, True)
    frame.addNode('lower-fore-rearbox', 92.265000, -7.500000, 5.907000, True, True)
    frame.addNode('lower-fore-rearbox#m', 92.265000, 7.500000, 5.907000, True, True)
    frame.addNode('lower-mid-rearbox', 97.543000, -6.238000, 4.911900, True, True)
    frame.addNode('lower-mid-rearbox#m', 97.543000, 6.238000, 4.911900, True, True)
    frame.addNode('lower-aft-rearbox', 103.246000, -6.237800, 5.904000, True, True)
    frame.addNode('lower-aft-rearbox#m', 103.246000, 6.237800, 5.904000, True, True)
    frame.addNode('upper-aft-rearbox', 105.572000, -9.056000, 10.968800, True, True)
    frame.addNode('upper-aft-rearbox#m', 105.572000, 9.056000, 10.968800, True, True)
    frame.addNode('upper-mid-rearbox', 99.500000, -8.825800, 10.956300, True, True)
    frame.addNode('upper-mid-rearbox#m', 99.500000, 8.825800, 10.956300, True, True)
    frame.addNode('upper-rearRockerPlane', 98.999972, -6.806331, 13.606063, True, True, 1.000000, 1.000000, 1.000000,
                  1.000000, 2.000000, 1.000000, 'RockerPlane')
    frame.addNode('upper-rearRockerPlane#m', 98.999972, 6.806331, 13.606063, True, True, 1.000000, 1.000000, 1.000000,
                  1.000000, 2.000000, 1.000000, 'RockerPlane')
    frame.addNode('pyramid', 98.094774, 0.000000, 18.930287, False, True, 1.000000, 1.000000, 0.000000, 0.000000,
                  3.000000, 0.000000, 'RockerPlane')
    frame.addNode('upper-aft-enginemount', 93.523300, -4.262500, 16.400000, True, True)
    frame.addNode('upper-aft-enginemount#m', 93.523300, 4.262500, 16.400000, True, True)
    frame.addNode('lower-aft-enginemount', 93.541300, -3.656500, 7.177000, True, True)
    frame.addNode('lower-aft-enginemount#m', 93.541300, 3.656500, 7.177000, True, True)
    ...
    frame.addTube(SQ_1x49, SQ_1x49, 'upper-left-bulkhead#m', 'lower-left-bulkhead#m', True, True)
    ...
    frame.addTube(RD_1x65, RD_1x65, 'upper-left-bulkhead#m', 'upper-left-fronthoop#m', True, True)
    frame.addTube(RD_1x49, RD_1x49, 'upper-left-bulkhead', 'upper-fore-left-frontbox', True, True)
    frame.addTube(RD_1x49, RD_1x49, 'upper-left-bulkhead#m', 'upper-fore-left-frontbox#m', True, True)
    frame.addTube(RD_1x49, RD_1x49, 'lower-left-bulkhead', 'upper-fore-left-frontbox', True, True)
    frame.addTube(RD_1x49, RD_1x49, 'lower-left-bulkhead#m', 'upper-fore-left-frontbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-left-bulkhead', 'lower-fore-left-frontbox', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'lower-left-bulkhead#m', 'lower-fore-left-frontbox#m', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox', 'left-rockernode', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox#m', 'left-rockernode#m', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'left-rockernode', 'lower-aft-left-frontbox', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'left-rockernode#m', 'lower-aft-left-frontbox#m', True, True, 'LowerFrontAArm')
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox', 'upper-fore-left-frontbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox#m', 'upper-fore-left-frontbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox', 'upper-aft-left-frontbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-fore-left-frontbox#m', 'upper-aft-left-frontbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-left-frontbox', 'upper-aft-left-frontbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-left-frontbox#m', 'upper-aft-left-frontbox#m', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'upper-fore-left-frontbox', 'fore-upper-left-sideimpact', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'upper-fore-left-frontbox#m', 'fore-upper-left-sideimpact#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-left-frontbox', 'left-frontdamper', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-left-frontbox#m', 'left-frontdamper#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-frontdamper', 'upper-left-fronthoop', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-frontdamper#m', 'upper-left-fronthoop#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-frontdamper', 'fore-upper-left-sideimpact', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-frontdamper#m', 'fore-upper-left-sideimpact#m', True, True)
    frame.addTube(RD_1x95, RD_1x95, 'lower-aft-left-frontbox', 'upper-aft-left-frontbox', True, True, 'FrontRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'lower-aft-left-frontbox#m', 'upper-aft-left-frontbox#m', True, True,
                  'FrontRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'upper-aft-left-frontbox', 'fore-upper-left-sideimpact', True, True,
                  'FrontRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'upper-aft-left-frontbox#m', 'fore-upper-left-sideimpact#m', True, True,
                  'FrontRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'fore-upper-left-sideimpact', 'upper-left-fronthoop', True, True, 'FrontRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'fore-upper-left-sideimpact#m', 'upper-left-fronthoop#m', True, True,
                  'FrontRollHoop')
    ...
    frame.addTube(RD_1x35, RD_5x35, 'upper-left-fronthoop#m', 'mid-upper-left-sideimpact#m', True, True)
    frame.addTube(RD_1x83, RD_5x35, 'fore-upper-left-sideimpact', 'mid-upper-left-sideimpact', True, True,
                  'UpperSideImpact')
    frame.addTube(RD_1x83, RD_5x35, 'fore-upper-left-sideimpact#m', 'mid-upper-left-sideimpact#m', True, True,
                  'UpperSideImpact')
    frame.addTube(RD_5x35, RD_5x35, 'upper-aft-left-frontbox', 'mid-upper-left-sideimpact', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-aft-left-frontbox#m', 'mid-upper-left-sideimpact#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-aft-left-frontbox', 'mid-upper-left-sideimpact', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-aft-left-frontbox#m', 'mid-upper-left-sideimpact#m', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'lower-aft-left-frontbox', 'left-lower-mainhoop', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'lower-aft-left-frontbox#m', 'left-lower-mainhoop#m', True, True)
    frame.addTube(RD_1x83, RD_5x35, 'mid-upper-left-sideimpact', 'left-sideimpact-mainhoop', True, True,
                  'UpperSideImpact')
    frame.addTube(RD_1x83, RD_5x35, 'mid-upper-left-sideimpact#m', 'left-sideimpact-mainhoop#m', True, True,
                  'UpperSideImpact')
    frame.addTube(RD_1x95, RD_1x95, 'left-lower-mainhoop', 'left-sideimpact-mainhoop', True, True, 'MainRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'left-lower-mainhoop#m', 'left-sideimpact-mainhoop#m', True, True, 'MainRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'left-sideimpact-mainhoop', 'left-harnessbar-mainhoop', True, True, 'MainRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'left-sideimpact-mainhoop#m', 'left-harnessbar-mainhoop#m', True, True,
                  'MainRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'left-harnessbar-mainhoop', 'left-brace-mainhoop', True, True, 'MainRollHoop')
    frame.addTube(RD_1x95, RD_1x95, 'left-harnessbar-mainhoop#m', 'left-brace-mainhoop#m', True, True, 'MainRollHoop')
    ...
    frame.addTube(RD_5x35, RD_5x35, 'left-sideimpact-mainhoop#m', 'engine-to-harness#m', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'engine-to-harness', 'foremost-enginemount', False, True)
    ...
    frame.addTube(RD_5x35, RD_5x35, 'left-brace-mainhoop#m', 'upper-fore-rearbox#m', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'left-lower-mainhoop', 'lower-fore-rearbox', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'left-lower-mainhoop#m', 'lower-fore-rearbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-lower-mainhoop', 'upper-fore-rearbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-lower-mainhoop#m', 'upper-fore-rearbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-sideimpact-mainhoop', 'upper-fore-rearbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'left-sideimpact-mainhoop#m', 'upper-fore-rearbox#m', True, True)
    frame.addTube(RD_1x95, RD_1x95, 'left-harnessbar-mainhoop', 'engine-to-harness', True, True, 'HarnessBar')
    frame.addTube(RD_1x95, RD_1x95, 'left-harnessbar-mainhoop#m', 'engine-to-harness#m', True, True, 'HarnessBar')
    frame.addTube(RD_1x95, RD_1x95, 'engine-to-harness', 'end-of-bend-harness', True, True, 'HarnessBar')
    frame.addTube(RD_1x95, RD_1x95, 'engine-to-harness#m', 'end-of-bend-harness#m', True, True, 'HarnessBar')
    ...
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox#m', 'lower-fore-rearbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox', 'lower-mid-rearbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox#m', 'lower-mid-rearbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-mid-rearbox', 'upper-aft-rearbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'lower-mid-rearbox#m', 'upper-aft-rearbox#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-aft-rearbox', 'lower-aft-rearbox', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-aft-rearbox#m', 'lower-aft-rearbox#m', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'lower-fore-rearbox', 'lower-aft-enginemount', True, True)
    frame.addTube(RD_1x35, RD_5x35, 'lower-fore-rearbox#m', 'lower-aft-enginemount#m', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'lower-aft-enginemount', 'lower-mid-rearbox', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'lower-aft-enginemount#m', 'lower-mid-rearbox#m', True, True)
    ...
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox#m', 'upper-mid-rearbox#m', True, True, 'UpperRearbox')
    frame.addTube(RD_5x35, RD_5x35, 'upper-mid-rearbox', 'upper-aft-rearbox', True, True, 'upperRearbox')
    frame.addTube(RD_5x35, RD_5x35, 'upper-mid-rearbox#m', 'upper-aft-rearbox#m', True, True, 'upperRearbox')
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox', 'upper-aft-enginemount', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox#m', 'upper-aft-enginemount#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox', 'upper-rearRockerPlane', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-fore-rearbox#m', 'upper-rearRockerPlane#m', True, True)
    frame.addTube(RD_5x35, RD_5x35, 'upper-rearRockerPlane', 'upper-aft-enginemount', True, True, 'toEngineMount')
    frame.addTube(RD_5x35, RD_5x35, 'upper-rearRockerPlane#m', 'upper-aft-enginemount#m', True, True, 'toEngineMount')
    frame.addTube(RD_5x35, RD_5x35, 'upper-rearRockerPlane', 'upper-aft-rearbox', True, True, 'toEngineMount')
    frame.addTube(RD_5x35, RD_5x35, 'upper-rearRockerPlane#m', 'upper-aft-rearbox#m', True, True, 'toEngineMount')
    frame.addTube(RD_5x35, RD_5x35, 'upper-mid-rearbox', 'upper-rearRockerPlane', True, False)
    frame.addTube(RD_5x35, RD_5x35, 'upper-mid-rearbox#m', 'upper-rearRockerPlane#m', True, False)
    ...
    frame.addTube(RD_1x65, RD_5x35, 'upper-aft-enginemount#m', 'pyramid', False, False)
    frame.addTube(RD_1x49, RD_5x35, 'lower-fore-rearbox', 'lower-mid-rearbox', True, True)
    frame.addTube(RD_1x49, RD_5x35, 'lower-fore-rearbox#m', 'lower-mid-rearbox#m', True, True)
    frame.addTube(RD_1x83, RD_5x35, 'lower-mid-rearbox', 'lower-aft-rearbox', True, True)
    frame.addTube(RD_1x83, RD_5x35, 'lower-mid-rearbox#m', 'lower-aft-rearbox#m', True, True)
    frame.addTube(RD_1xSLD, RD_1xSLD, 'upper-aft-enginemount', 'lower-aft-enginemount', True, True)
    frame.addTube(RD_1xSLD, RD_1xSLD, 'upper-aft-enginemount#m', 'lower-aft-enginemount#m', True, True)
