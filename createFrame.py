...
def createFrame():
    ...
    frame.addNode("upper-left-bulkhead", 17.852, -6.929, 17.195, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-left-bulkhead", 17.852, -6.929, 4.82, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-fore-left-frontbox", 33.203, -8.69, 8.932, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-fore-left-frontbox", 33.652, -6.929, 4.82, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-aft-left-frontbox", 44.194, -8.584, 8.907, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-aft-left-frontbox", 43.97, -6.929, 4.82, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("left-frontdamper", 40.2, -9, 17.25, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("fore-upper-left-sideimpact", 44.731, -8.497, 12.5, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-left-fronthoop", 46.445, -6.53, 23.133, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("mid-upper-left-sideimpact", 58.353, -10.751, 12.737, True, False, 3, 3, 3, 3, 3, 3)
    frame.addNode("left-lower-mainhoop", 73.15, -13.25, 2, True, True, 3, 3, 3, 3, 3, 3, "MainHoop")
    frame.addNode("left-sideimpact-mainhoop", 73.15, -13.2, 12.993, True, True, 3, 3, 3, 3, 3, 3, "MainHoop")
    frame.addNode("left-harnessbar-mainhoop", 73.15, -10.55, 23.1, True, True,  3, 3, 3, 3, 3, 3,"MainHoop")
    frame.addNode("left-brace-mainhoop", 73.15, -6.273, 38.5, True, True, 3, 3, 3, 3, 3, 3, "MainHoop")
    frame.addNode("nipple-mainhoop", 73.15, 0, 44.2, False, True, 3, 3, 3, 3, 3, 3, "MainHoop")
    frame.addNode("seat-crossbrace", 59.114, 0, 3.217, False, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("frontbox-crossbrace", 38.811, 0, 4.82, False, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("left-rockernode", 40.2, -6.929, 4.82, True, True, 3, 3, 3, 3, 3, 3)
    frame.addNode("engine-to-harness", 75.698,-9.598,23.1,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("foremost-enginemount", 79.706, -7.6675,14.875,False,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("end-of-bend-harness",76.65, -7.3,23.1,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-fore-rearbox", 93.5544,-8.6,10.944,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-fore-rearbox",92.265, -7.5,5.907,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-mid-rearbox",97.543,-6.238,4.9119,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-aft-rearbox",103.246, -6.2378,5.904,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-aft-rearbox",105.572,-9.056,10.9688, True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-mid-rearbox", 99.5,-8.8258,10.9563,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("upper-rearRockerPlane", 99.5,-6.64,13.706,True,True, 3, 3, 3, 3, 3, 3,"RockerPlane")
    frame.addNode("pyramid",99.5,0,17,False,True,3,3,3,3,3,3, "RockerPlane")
    frame.addNode("upper-aft-enginemount", 93.5233,-4.2625,16.4,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("lower-aft-enginemount",93.5413, -3.6565,7.177,True,True, 3, 3, 3, 3, 3, 3)
    frame.addNode("foremost-enginemount-mirror", 79.03,7.648,14.38,False,True, 3, 3, 3, 3, 3, 3)
