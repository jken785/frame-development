...
def createBaseFrame():
    ...
    frame.addNode("left-lower-mainhoop", 73.15, -13.25, 2, True, True, 0, 0, 2, 3, 0, 0, "MainHoop")
    frame.addNode("left-sideimpact-mainhoop", 73.15, -13.2, 12.993, True, True, 0, 0, 1, 4, 0, 0, "MainHoop")
    frame.addNode("left-harnessbar-mainhoop", 73.15, -10.55, 23.1, True, True, "MainHoop")
    frame.addNode("left-brace-mainhoop", 73.15, -6.273, 38.5, True, True, 0, 0, 0, 2, 0, 2, "MainHoop")
    frame.addNode("nipple-mainhoop", 73.15, 0, 44.2, False, True, 0, 0, 0, 0, 3, 1, "MainHoop")
